    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.date(2021, 2, 26))),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_reservation', models.DateTimeField(default=datetime.date(2021, 2, 26))),
                ('time_reservation', models.DateTimeField(default=datetime.time(19, 28, 19, 912752))),
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservation_name', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
